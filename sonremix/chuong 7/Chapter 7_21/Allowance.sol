...
contract Allowance is Ownable{ 
      ...
      event AllowanceChanged(address indexed _forwho, address _frowhom, uint _oldAmount, uint _newAmount);
    ...
    modifier ownerOrAllowed(uint _amount){
        require(isOwner()|| allowance[msg.sender] >= _amount, "You are not allower");
        _;
    }
